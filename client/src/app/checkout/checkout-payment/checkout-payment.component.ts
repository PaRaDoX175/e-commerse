...
export class CheckoutPaymentComponent implements OnInit {
  ...
  ngOnInit(): void {
    loadStripe(
      "pk_test_51LqGoHGyV6C52Rn7GG3JiQTh81NrZz3jCtLX0p9g853KqHFEkkUeZatERVYdXcrURQHfTHtCdXKVzlNKfhf7olK1007tYabu5l"
    ).then(stripe => {
      this.stripe = stripe;
  ...
  private async confirmPaymentWithStripe(basket: Basket | null) {
    ...
    const result = this.stripe?.confirmCardPayment(
      basket.clientSecret as string,
      {
        payment_method: {
